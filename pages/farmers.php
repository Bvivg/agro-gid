...
$stmt = $connect->prepare("SELECT * FROM users WHERE profession = 'farmer'");
$stmt->execute();
...
$column = "username";
$column2 = "";
$special = "profession = 'farmer' AND " . $column2 . " LIKE :searchQuery OR ";
...
<div class="workers">
  ...
  <?php else : ?>
    <?php foreach ($users as $user) : ?>
      <a href="farmer?id=<?php echo $user['id'] ?>" class="workers-card">
        <?php
